# Define a function to find the truth by shifting the letter
...
def lassoLetter( letter, shiftAmount ):
    ...
    # The formula to calculate the ASCII number for
    # the decoded letter
...
# Shift the letter in a word by a specified amount to discover the
# hidden
def lassoWord( word, shiftAmount ):
    ...
    # This for loop iterates through each letter in the work parameter
    for letter in word:
